...
fff : UserDto[];
//webserverのURL
public hostUrl = 'http://54.150.201.245:8080'; //web api URLとして
...
public  httpOptions = {
  ...
  public getHeroes(): Observable<UserDto[]> {
      return this.http.get<UserDto[]>('http://54.150.201.245:8080/practice1/sample/sample2/getSample', this.httpOptions)
      .pipe(
  ...
  public posting(e):Observable<UserDto[]> {
    ...
    return this.http.post<UserDto[]>('http://54.150.201.245:8080/practice1/sample/sample2/postSample', postdata, this.httpOptions)
    .pipe(
  ...
  public postlogin(aa: Userlog): Observable<any> {
   ...
   // let postdata = JSON.stringify( eee );
    return this.http.post<Userlog[]>('http://54.150.201.245:8080/practice1/sample/sample2/postlogin', eee, this.httpOptions)
    .pipe(
      catchError(this.handleError),
    );
}
